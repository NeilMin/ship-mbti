...
结构（每型）：① 场景开场把人钉死 → ② 两句处刑（截图点）→ ③ 结尾立场反转（先扎再抱）。strengths 写成"公司留你的理由"口吻；risks 写成"事故预告"口吻；lifestyle 必含真实 milieu 细节。素材池（16 型各取所需，禁止两型撞同一细节）：

- 日常：Costco/大华采购、新店排队两小时、美食荒漠之争、特斯拉（仅作"码农标配车"中性梗）
- 户外：湾区三俗（hiking/摘樱桃/露营——"跟老中露营根本是 cook out"）、"最大的三俗是整天讨论三俗"、Tahoe 滑雪、"钓鱼是为讨好老板，行头一身俨然半个专家"
- 社交：狼人杀局、"南湾只有桌游、奇怪的读书会和 hiking"、"社交话题永远是跳槽股票包裹"、"包裹+绿卡教"、"抱怨话题单一的人和聊这些的是不是一批人"、相亲现场（PPT 男/奶茶店筛选/比包裹）
- 穿搭：文化衫比 LV 更有身份感、年入百万穿得像低保户、Patagonia 马甲、"鄙视链不在穿什么，在编辑器快捷键"
- 宅：NAS/软路由/homelab（"折腾完 NAS，接下来存什么？"）、"等我财富自由，用 20 种语言跟你谈风花雪月"
